...
export const managerAssignmentApi = {
  managers: () => api.get('/manager-assignments/managers'),

  interns: () => api.get('/manager-assignments/interns'),

  assign: (internId, data) =>
    api.put(`/manager-assignments/${internId}`, data),

  remove: (internId) =>
    api.delete(`/manager-assignments/${internId}`),

  history: (internId) =>
    api.get(`/manager-assignments/${internId}/history`),
};
...
export const taskApi = {
  ...
  review: (taskId, submissionId, data) =>
    api.put(
...
export const attendanceApi = {
  ...
  summary: (internId) =>
    api.get(`/attendance/summary/${internId || ''}`),
};
...
export const reportApi = {
  interns: (params) =>
    api.get('/reports/interns', { params }),
  attendance: (params) =>
